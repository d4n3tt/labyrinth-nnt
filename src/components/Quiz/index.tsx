...
const Quiz: React.FC = () => {
  return (
    <>
      {new Date() >= new Date("03/01/2020 00:00:00") &&
        window.location.pathname === `/start` && (
          <>
            ...
            <S.Text>
              ...
              <br />
              <br />
              파티룸의 한 가운데는 테이블과 8명이 둘러앉을 수 있는 의자가
              있었다.
              <br />
              <br />
              ...
              <br />
              <br />
              “그러고 보니 저는 초대장에 문제를 만들어오라고 적혀 있었는데
              님들도 그렇게 적혀 있었나요?”
              <br />
              <br />
      ...
      {new Date() >= new Date("01/04/2020 00:00:00") &&
        window.location.pathname === `/lenggo` && (
          <>
            <S.Number>1</S.Number>
            <S.Text>
              “어? 이거 저한테만 있는거였어요?”
      ...
      {new Date() >= new Date("01/06/2020 00:00:00") &&
      ...
      {new Date() < new Date("01/06/2020 00:00:00") &&
        window.location.pathname === `/sun` && (
          <>
            <Clock date={new Date("01/06/2020 00:00:00")} />
          </>
        )}
      ...
      {new Date() >= new Date("01/08/2020 00:00:00") &&
      ...
      {new Date() >= new Date("01/10/2020 00:00:00") &&
